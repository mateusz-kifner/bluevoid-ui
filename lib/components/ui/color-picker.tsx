...
import equalHSV from "./color-picker-parts/equalHSV";
...
import AlphaSlider from "./color-picker-parts/AlphaSlider";
import ColorArea from "./color-picker-parts/ColorArea";
import ColorSwatches from "./color-picker-parts/ColorSwatches";
import HueSlider from "./color-picker-parts/HueSlider";
import { colors } from "./color-picker-parts/colors";
import useColor from "./color-picker-parts/useColor";
...
function ColorPicker(props: ColorPickerProps) {
  ...
  return (
    <div className={"relative flex w-[388px] flex-col gap-3 p-3"}>
      ...
      <div
        className={`absolute bottom-0 left-0 flex w-full flex-col gap-3 overflow-hidden bg-stone-200 transition-all dark:bg-stone-950${openPalette ? "h-full p-3" : "h-7 px-3"
          }`}
      >
        <button
          type="button"
